//
//  ProfileBeerInfoViewController.m
//  CraftsBeerApp
//
...
@interface ProfileBeerInfoViewController ()

@end

@implementation ProfileBeerInfoViewController
...
- (void)viewDidLoad
{
    ...
    NSString *path = [[NSBundle mainBundle] pathForResource:@"BrewHorn Instructions- Profile the Beer" ofType:@"pdf"];
