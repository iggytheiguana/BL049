...
@interface YourTasteInfoViewController ()

@end

@implementation YourTasteInfoViewController
...
- (void)viewDidLoad
{
    ...
    NSString *path = [[NSBundle mainBundle] pathForResource:@"BrewHorn Instructions- Your Taste Profile" ofType:@"pdf"];
