...
@interface AddBeerInfoViewController ()

@end

@implementation AddBeerInfoViewController
...
- (void)viewDidLoad
{
    ...
    NSString *path = [[NSBundle mainBundle] pathForResource:@"BrewHorn Instructions- Add a Beer" ofType:@"pdf"];
