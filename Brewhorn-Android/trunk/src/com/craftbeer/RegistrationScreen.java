...
public class RegistrationScreen extends Activity implements HttpListener {
	...
	private CheckBox chk_box_automated_sharing_facebook_reg;
	private CheckBox chk_box_automated_sharing_twitter_reg;
	...
	private void initializeView() {
		...
		// facebook
		chk_box_automated_sharing_facebook_reg = (CheckBox) findViewById(R.id.automate_sharing_toggle_facebook_reg);
		chk_box_automated_sharing_facebook_reg.setChecked(false);

		// Twitter
		chk_box_automated_sharing_twitter_reg = (CheckBox) findViewById(R.id.automate_sharing_toggle_twitter_reg);
		chk_box_automated_sharing_twitter_reg.setChecked(false);
		...
		imgTermsCondition.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri
						.parse("http://www.netsmartz.net/portfolio"));
		...
		_btnRegister.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (!CheckInternetConnectivity
					...
					Log.i("Zip", "" + _editZip.getText().toString());
					Log.i("automated_sharing_facebook_reg", "" + chk_box_automated_sharing_facebook_reg.isChecked());
					Log.i("automated_sharing_twitter_reg", "" + chk_box_automated_sharing_twitter_reg.isChecked());

					SharedPreferences.Editor editor = _sharedPref.edit();
					if (chk_box_automated_sharing_facebook_reg.isChecked()) {
						editor.putBoolean(Constants.AUTO_SHARE_FACEBOOK, true);
					} else {
						editor.putBoolean(Constants.AUTO_SHARE_FACEBOOK, false);
					}

					if (chk_box_automated_sharing_twitter_reg.isChecked()) {
